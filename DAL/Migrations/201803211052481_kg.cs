namespace DAL.Migrations
{
    ...
    public partial class kg : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        EtiketeYazilacakYazi = c.String(maxLength: 25),
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.SiparisId)
                .ForeignKey("dbo.Siparisler", t => t.SiparisId)
                .ForeignKey("dbo.DavetiyeKataloglari", t => t.DavetiyeKatalogu_Id)
                .Index(t => t.SiparisId)
                .Index(t => t.DavetiyeKatalogu_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.SunnetDavetiyeSiparisleri", "DavetiyeKatalogu_Id", "dbo.DavetiyeKataloglari");
            ...
            DropForeignKey("dbo.DavetiyeSiparisleri", "DavetiyeKatalogu_Id", "dbo.DavetiyeKataloglari");
            ...
            DropIndex("dbo.SunnetDavetiyeSiparisleri", new[] { "DavetiyeKatalogu_Id" });
            ...
            DropIndex("dbo.DavetiyeSiparisleri", new[] { "DavetiyeKatalogu_Id" });
